...
const steps = [
  {
    ...
    description:
      "Tailor-made roadmaps to address your unique infrastructure challenges, ensuring sustainable growth and technological advantage.",
  },
  {
    title: "End-to-End Financial Operations",
    description:
      "Streamline your payment processes and improve efficiency with our unified gateway and core banking expertise.",
  },
  {
    title: "Data-Driven Operational Efficiency",
    description:
      "Optimize your workflow and resource management through our integrated HRMS, EDMS, and CRM solutions.",
  },
  {
    title: "Strategic Talent Acquisition",
    description:
      "Enhance your technical capabilities and build high-performing teams through our specialized TaaS methodology.",
  },
];
        ...
        >
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-foreground uppercase leading-[0.9]">
              What we <br />{" "}
              <span className="text-primary italic">Can Do For You?</span>
            </h2>
          </div>
          <p className="text-muted-foreground max-w-sm text-sm md:text-base leading-relaxed">
            From digital transformation to specialized talent, we provide the
            expertise needed to scale your technical infrastructure.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-primary p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              <h4 className="text-3xl md:text-4xl font-bold text-primary-foreground tracking-tight">
                Free consultation
              </h4>
            </div>
