            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20">
                    ...
                    <div className="space-y-6">
                        <h4 className="text-xs font-black uppercase tracking-[0.3em] text-primary">Infrastructure</h4>
                        <ul className="space-y-4">
                            {allServices.slice(0, 5).map((service) => (
                                <li key={service.slug}>
                                    <Link href={`/products/${service.slug}`} className="text-muted-foreground hover:text-primary transition-colors text-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4">
                            {["Partners", "Resources", "Contact", "Careers", "About"].map((item) => (
                                <li key={item}>
                                    <Link
                    ...
                    {/* Status Column */}
                    <div className="space-y-6">
                        <h4 className="text-xs font-black uppercase tracking-[0.3em] text-primary">Status</h4>
                        <div className="space-y-4">
                            <div className="p-4 rounded-2xl bg-secondary/50 border border-border/10">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-bold">All Nodes Operational</span>
                                </div>
                            </div>
                            ...
                            <div className="relative group">
                                ...
                                />
                                <button className="absolute right-1 top-1 w-9 h-9 rounded-full bg-primary flex items-center justify-center text-white group-hover:scale-105 transition-transform" aria-label="Subscribe">
                ...
                <div className="pt-12 border-t border-border/10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex flex-wrap justify-center gap-8 text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">
                        ...
                        <a href="#" className="hover:text-primary transition-colors">Information Security</a>
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/30 border border-border/10">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">Global Operations Enabled</span>
                    </div>
                </div>
            </div>
        </footer>
